...
void AMyProject2Pawn::BeginPlay()
{
	Super::BeginPlay();

	// set up the flipped check timer
	GetWorld()->GetTimerManager().SetTimer(FlipCheckTimer, this, &AMyProject2Pawn::FlippedCheck, FlipCheckTime, true);
}

void AMyProject2Pawn::EndPlay(EEndPlayReason::Type EndPlayReason)
{
...
void AMyProject2Pawn::FlippedCheck()
{
